...
**nf-core/nfvibrio** is a bioinformatics best-practice analysis pipeline for Vibrio _parahaemolyticus_ analysis. This workflow is under active development and updates. If you are using it always remember to sync your fork. 
